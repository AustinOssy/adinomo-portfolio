...
function Home() {
	return (
		<div className="home__content container d-flex align-items-center justify-content-center text-center pt-5 pb-5 mt-3">
			<div className="d-flex flex-column align-items-center justify-content-center text-center">
				...
				<p className="home__text">
					...
					interfaces and web based components with interactive functionality
