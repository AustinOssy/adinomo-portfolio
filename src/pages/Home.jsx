	...
	return (
      <div className="flex flex-col items-center mt-20 relative bg-home">
         ...
         <p className="max-w-[900px] w-full z-20 text-[25px] px-5 text-center">
            I am a passionate Frontend Developer skilled in creating highly
            interactive user interfaces and innovative web components that
            significantly enhance product success and user satisfaction
         </p>
         <Link
