...
import bota from "/src/assets/img/bota.png";
import estore from "/src/assets/img/e-store.png";
import { FiExternalLink } from "react-icons/fi";
import { FaGithub } from "react-icons/fa";
import bravestrides from "/src/assets/img/bravestrides.png";
...
function Projects() {
      ...
      <div className="w-[350px] group cursor-pointer rounded-[0.3rem] relative shadow-[0px_3px_10px_0px] shadow-success2">
        ...
        <div className="card-info transition-all ">
          ...
          <div className="flex gap-x-3">
            ...
            <a href={props.link} className="inline">
              <FaGithub
                size={33}
  ...
  return (
    <div id="projects" className="min-h-[650px] mt-20">
      <h2 className="heading h-[65px]">My Works</h2>
      <div className="mt-5 grid sm:grid-cols-2 lg:grid-cols-3 mx-auto gap-14 w-fit">
        ...
        <div className="w-fit h-400px">
          <ProjectCard
            name="Bota"
            img={bota}
            tech="HTML, CSS, Tailwind, Nextjs, DaisyUI, Redux-toolkit"
            link={"https://botaplace.com/"}
          />
        </div>
        <div className="w-fit h-400px">
          <ProjectCard
